...
class ReAct(dspy.Module):
    def __init__(self):
        ...
        self.gen_ans = dspy.ReAct('question -> answer')  # depending on our use case, we can have our signature and other parameters.
...
if RUN_FROM_SCRATCH:
    ...
    cot_bs = teleprompter.compile(ReAct(), trainset=trainset, valset=devset)
